...
console.log(`The last car's make and model is `+inventory[lastCar].car_make + ` `+inventory[lastCar].car_model);
...
console.log(oldCars.length+" cars are older than the year 2000."); 
